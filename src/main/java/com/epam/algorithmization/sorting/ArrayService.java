...
public class ArrayService {
    ...
    private static final int DEFAULT_RANGE_OF_ARRAY_LENGTH = 100;
    private static final int DEFAULT_RANGE_OF_NUMBERS_VALUES = 200;
    private static final int DEFAULT_RANGE_OF_MATRIX_ARRAY_LENGTH = 20;
    private static final int DEFAULT_MIN_MATRIX_ARRAY_LENGTH = 10;
    private static final String FORMAT_PATTERN_FOR_INTS = "%5d";
    private static final String FORMAT_PATTERN_FOR_FLOATS = "%14.8f";
