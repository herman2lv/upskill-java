package com.epam.classes.simplestClasses.task6;

import java.text.DecimalFormat;

public class TimeCounter {
    final static int NUMBER_OF_SECONDS_IN_MINUTE = 60;
    final static int NUMBER_OF_MINUTES_IN_HOUR = 60;
