...
public class XMLAnalyzer {
    static final int INDEX_OF_SECOND_CHAR_IN_STRING = 1;
    static final int INDEX_OF_LAST_CHAR_IN_STRING = -1;
    static final int INDEX_OF_PRE_LAST_CHAR_IN_STRING = -2;
    ...
    public void analyze(String text) {
        ...
        while (matcher.find()) {
            ...
            if (matcher.group().indexOf('/') < 0) {
                System.out.printf("%n%sTag \"", tabulation);
